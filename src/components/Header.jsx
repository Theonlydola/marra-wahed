...
export default function Header() {
    ...
    return (
    <Box w="100%" bg="#DF2E2E" align="center" backgroundImage = {pattern}>
    <HStack mr="2em" ml="2em" align="center" spacing="24px"> 
    <HStack mt="4em" w="65em"></HStack>
    <Link className="font-link" fontSize="1.5em" color="white" href="/tellAjoke" textDecoration="underline"> ابعتلنا نكتة</Link>
    <Link className="font-link" fontSize="1.5em" color="white" href="/about" textDecoration="underline">عننا</Link>
    </HStack>
    <VStack h="1em" ml="2em"> </VStack> 
    <Image ml="2em" mb="1em" h="auto" w="30%" src={logo} imagealt="مرة واحد" onClick={handlelogoClick}/> 
