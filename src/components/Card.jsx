...
import Share from './share';
  ...
  export default function Card(props) {
    ...
    return <Box mt="-1em" align="center"> 
  <VStack spacing="2em" mt="1em">
    <Box height="auto" width="90%" borderRadius="lg" backgroundColor="#FFF7AE" align="center" boxShadow="10px 10px #F6D167">
          ...
          <Box mb="1em" ml="1em" mt="1em" mr="1em" align="center">
          <HStack>
              <HStack mr="2em"> 
              <Text> <Icon as={BsEgg}  /> {dislikescount > 999 ? (dislikescount/1000).toFixed(1) + "k": dislikescount} </Text>
              <Text> <Icon as={BsHeart}   /> {likescount > 999 ? (likescount/1000).toFixed(1)   + "k": likescount} </Text>
              </HStack>
            {props.joke.author&& <Badge className="font-link" fontSize="105%" colorScheme="green">{props.joke.author}</Badge>} 
            {props.joke.name&& <Badge  className="font-link" fontSize="105%" colorScheme="green">{props.joke.name}</Badge>} 
          </HStack>
          </Box>
    </Box>
